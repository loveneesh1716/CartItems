...
class CartItem extends React.Component{
    ...
    increaseQuantity = () =>
    {
      ...
      //setState form 1
      //if we call this function multiple time then result will be only last function due to batches concept
      //  this.setState({
      ...
      // setState form 2
      //if we call function multiple time result will be all functions
        this.setState((prevState) =>{
            return {
                qty: prevState.qty + 1
            }
        // call back function for setState 
            ...
            <div className="cart-item">
                ...
                <div className="righr-block">
                    ...
                    <div className="cart-item-action">
                        {/* Button */ }
                        <img alt="increase" onClick={this.increaseQuantity} className="action-icons" src="https://img-premium.flaticon.com/png/512/2716/2716401.png?token=exp=1621366842~hmac=231eca31473d03ecd242f8523162a165"/>
                        <img alt="decrease" onClick={this.decreaseQuantity}style={{height:22 , width:22}} classNmae="action-icons" src="https://img-premium.flaticon.com/png/512/2716/2716405.png?token=exp=1621367145~hmac=ecdf91177bf9f9a5afe5c023374b1067"/>
